...
os.environ["CUDA_VISIBLE_DEVICES"] = "7,6,5,4,3,2"
...
history = unet_model.fit(trainGene, validation_data=validGene, \
                            validation_steps=50, steps_per_epoch=1000, epochs=10, verbose=2, \
...
plot_model(unet_model, to_file="/data/Users/izumi/unet/2008/data/membrane/logs/"+curr_time+"_model.png")
