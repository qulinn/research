...
def crf(original_image, annotated_image, use_2d=True):
    ...
    Args:
        original_image (image): RGB Image.
        annotated_image (image): Segmentation result or annotation.
        use_2d (bool, optional): CRF for 2D data. Defaults to True.
            If `True`, 2D fucntions will be applied.
            If `False`, generic functions will be applied.
